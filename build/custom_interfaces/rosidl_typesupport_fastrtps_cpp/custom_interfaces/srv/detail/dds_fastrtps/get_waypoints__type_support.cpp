...
#include "custom_interfaces/srv/detail/get_waypoints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::srv::GetWaypoints_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::GetWaypoints_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::GetWaypoints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::GetWaypoints_Request *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_GetWaypoints_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, GetWaypoints_Request)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_GetWaypoints_Request__handle;
}
...
{
bool cdr_serialize(
  const custom_interfaces::msg::Waypoint &,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::srv::GetWaypoints_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: waypoints
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::GetWaypoints_Response & ros_message)
{
  // Member: waypoints
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Waypoint(
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::GetWaypoints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::GetWaypoints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_GetWaypoints_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, GetWaypoints_Response)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_GetWaypoints_Response__handle;
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_GetWaypoints__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, GetWaypoints)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_GetWaypoints__handle;
}
