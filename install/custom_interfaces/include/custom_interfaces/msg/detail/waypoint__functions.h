...
#ifndef CUSTOM_INTERFACES__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
#define CUSTOM_INTERFACES__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
 ...
 * calls
 * custom_interfaces__msg__Waypoint__init().
...
/**
 * It calls
 * custom_interfaces__msg__Waypoint__fini()
 ...
 * custom_interfaces__msg__Waypoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_interfaces__msg__Waypoint__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_INTERFACES__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
