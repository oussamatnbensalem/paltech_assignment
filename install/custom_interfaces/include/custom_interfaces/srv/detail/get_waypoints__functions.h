...
#ifndef CUSTOM_INTERFACES__SRV__DETAIL__GET_WAYPOINTS__FUNCTIONS_H_
#define CUSTOM_INTERFACES__SRV__DETAIL__GET_WAYPOINTS__FUNCTIONS_H_
 ...
 * calls
 * custom_interfaces__srv__GetWaypoints_Request__init().
...
/**
 * It calls
 * custom_interfaces__srv__GetWaypoints_Request__fini()
 ...
 * custom_interfaces__srv__GetWaypoints_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_interfaces__srv__GetWaypoints_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__GetWaypoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__GetWaypoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__GetWaypoints_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__GetWaypoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACES__SRV__DETAIL__GET_WAYPOINTS__FUNCTIONS_H_
