...
class GetWaypoints_Response(metaclass=Metaclass_GetWaypoints_Response):
    ...
    _fields_and_field_types = {
        'waypoints': 'sequence<custom_interfaces/Waypoint>',
        'success': 'boolean',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['custom_interfaces', 'msg'], 'Waypoint')),  # noqa: E501
...
class Metaclass_GetWaypoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.GetWaypoints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _get_waypoints
...
class GetWaypoints(metaclass=Metaclass_GetWaypoints):
    from custom_interfaces.srv._get_waypoints import GetWaypoints_Request as Request
    from custom_interfaces.srv._get_waypoints import GetWaypoints_Response as Response
